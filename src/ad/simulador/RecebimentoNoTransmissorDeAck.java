...
public class RecebimentoNoTransmissorDeAck extends Evento{

	public RecebimentoNoTransmissorDeAck(double tempo) {
		super(tempo);
	...
	// Ela representa o momento em que um ACK enviado
	// para um transmissor eh recebido pelo mesmo.
