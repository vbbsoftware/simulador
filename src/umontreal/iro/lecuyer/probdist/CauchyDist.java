...
/**
 * Extends the class {@link ContinuousDistribution} for the <EM>Cauchy</EM>
 * distribution with location parameter <SPAN CLASS="MATH"><I>&#945;</I></SPAN>
 * and scale parameter <SPAN CLASS="MATH"><I>&#946;</I> &gt; 0</SPAN>. The
 * density function is given by
 * 
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>f</I> (<I>x</I>) =
 * <I>&#946;</I>/(<I>&#960;</I>[(<I>x</I> - <I>&#945;</I>)<SUP>2</SUP> +
 * <I>&#946;</I><SUP>2</SUP>]) for - &#8734; &lt; <I>x</I> &lt; &#8734;. </DIV>
 * <P>
 * </P>
 ...
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>F</I>(<I>x</I>) = 1/2 +
 * arctan((<I>x</I> -
 * <I>&#945;</I>)/<I>&#946;</I>)/<I>&#960;</I>,&nbsp;&nbsp;&nbsp
 * ;&nbsp;&nbsp;&nbsp
 * ;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for - &#8734;
 * &lt; <I>x</I> &lt; &#8734;, </DIV>
 * <P>
 ...
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>F</I><SUP>-1</SUP>(<I>u</I>) =
 * <I>&#945;</I> + <I>&#946;</I>tan(<I>&#960;</I>(<I>u</I> -
 * 1/2)).&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for 0 &lt; <I>u</I>
 * &lt; 1. </DIV>
 * <P>
 * </P>
...
public class CauchyDist extends ContinuousDistribution {
	...
	/**
	 * Constructs a <TT>CauchyDist</TT> object with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I> = 0</SPAN> and <SPAN
	 * CLASS="MATH"><I>&#946;</I> = 1</SPAN>.
	 * 
	 */
	public CauchyDist() {
		setParams(0.0, 1.0);
	 ...
	 * CLASS="MATH"><I>&#946;</I> =</SPAN> <TT>beta</TT>.
	 * 
	 */
	 ...
	 * <I>&#946;</I>)</SPAN> of the Cauchy distribution using the maximum
	...
	public static double[] getMLE(double[] x, int n) {
		...
		Uncmin_f77.optif0_f77(2, param, system, xpls, fpls, gpls, itrcmd, a,
				udiag);
	...
	/**
	 * Creates a new instance of a Cauchy distribution with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#946;</I></SPAN> estimated using the maximum likelihood
	...
	/**
	 * Returns <SPAN CLASS="MATH">&#8734;</SPAN> since the variance does not
	 * exist.
	 * 
	...
	/**
	 * Returns <SPAN CLASS="MATH">&#8734;</SPAN> since the standard deviation
	 * does not exist.
	 * 
	 * @return <SPAN CLASS="MATH">&#8734;</SPAN>
	 * 
	...
	/**
	 * Returns the value of <SPAN CLASS="MATH"><I>&#945;</I></SPAN> for this
	 * object.
	 * 
	 */
	...
	/**
	 * Returns the value of <SPAN CLASS="MATH"><I>&#946;</I></SPAN> for this
	 * object.
	 * 
	 */
	...
	/**
	 * Sets the value of the parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN>
	 * and <SPAN CLASS="MATH"><I>&#946;</I></SPAN> for this object.
	 * 
	 */
