 ...
 * class. Such distributions are characterized by a <SPAN
 * CLASS="textit">density</SPAN> function <SPAN CLASS="MATH"><I>f</I>
 * (<I>x</I>)</SPAN>, thus the signature of a <TT>density</TT> method is
 * supplied here. This class also provides default implementations for <SPAN
 * CLASS="MATH">bar(F)(<I>x</I>)</SPAN> and for <SPAN
 * CLASS="MATH"><I>F</I><SUP>-1</SUP>(<I>u</I>)</SPAN>, the latter using the
 * Brent-Dekker method to find the inverse of a generic distribution function
...
public abstract class ContinuousDistribution implements Distribution {
	...
	protected static final double[] EPSARRAY = { 0.5, 0.5E-1, 0.5E-2, 0.5E-3,
			0.5E-4, 0.5E-5, 0.5E-6, 0.5E-7, 0.5E-8, 0.5E-9, 0.5E-10, 0.5E-11,
			0.5E-12, 0.5E-13, 0.5E-14, 0.5E-15, 0.5E-16, 0.5E-17, 0.5E-18,
			0.5E-19, 0.5E-20, 0.5E-21, 0.5E-22, 0.5E-23, 0.5E-24, 0.5E-25,
			0.5E-26, 0.5E-27, 0.5E-28, 0.5E-29, 0.5E-30, 0.5E-31, 0.5E-32,
			0.5E-33, 0.5E-34, 0.5E-35 };

	/**
	 * Returns <SPAN CLASS="MATH"><I>f</I> (<I>x</I>)</SPAN>, the density
	 ...
	 * implementation computes <SPAN CLASS="MATH">bar(F)(<I>x</I>) = 1 -
	 * <I>F</I>(<I>x</I>)</SPAN>.
	 * 
	 * @param x
	...
	/**
	 * Computes the inverse distribution function <SPAN CLASS="MATH"><I>x</I> =
	 * <I>F</I><SUP>-1</SUP>(<I>u</I>)</SPAN>, using the Brent-Dekker method.
	 * The interval <SPAN CLASS="MATH">[<I>a</I>, <I>b</I>]</SPAN> <SPAN
	 * CLASS="textit">must</SPAN> contain the root <SPAN
	 * CLASS="MATH"><I>x</I></SPAN> such that <SPAN
	 * CLASS="MATH"><I>F</I>(<I>a</I
	 * >)&nbsp;&lt;=&nbsp;<I>u</I>&nbsp;&lt;=&nbsp;<I>F</I>(<I>b</I>)</SPAN>,
	 * where <SPAN CLASS="MATH"><I>u</I> = <I>F</I>(<I>x</I>)</SPAN>. The
	 * calculations are done with an approximate precision of <TT>tol</TT>.
	 * Returns <SPAN CLASS="MATH"><I>x</I> =
	 * <I>F</I><SUP>-1</SUP>(<I>u</I>)</SPAN>. Restrictions: <SPAN
	 * CLASS="MATH"><I>u</I>&#8712;[0, 1]</SPAN>.
	 * 
	 * @param a
	...
	public double inverseBrent(double a, double b, double u, double tol) {
		...
		if (i >= MAXITER) {
			...
			System.out.println(lineSep
					+ "*********** inverseBrent:   no convergence after "
					+ MAXITER + " iterations");
		}
		return b;
	}
	...
	/**
	 * Computes and returns the inverse distribution function <SPAN
	 * CLASS="MATH"><I>x</I> = <I>F</I><SUP>-1</SUP>(<I>u</I>)</SPAN>, using
	 * bisection. Restrictions: <SPAN CLASS="MATH"><I>u</I>&#8712;[0, 1]</SPAN>.
	 * 
	 * @param u
	 *            value at which the inverse distribution function is evaluated
	 * 
	 ...
	 *                if <SPAN CLASS="MATH"><I>u</I></SPAN> is not in the
	...
	/**
	 * Returns the inverse distribution function <SPAN CLASS="MATH"><I>x</I> =
	 * <I>F</I><SUP>-1</SUP>(<I>u</I>)</SPAN>. Restrictions: <SPAN
	 * CLASS="MATH"><I>u</I>&#8712;[0, 1]</SPAN>.
	 * 
	 * @param u
	...
	/**
	 * Returns <SPAN CLASS="MATH"><I>x</I><SUB>a</SUB></SPAN> such that the
	 * probability density is 0 everywhere outside the interval <SPAN
	 * CLASS="MATH">[<I>x</I><SUB>a</SUB>, <I>x</I><SUB>b</SUB>]</SPAN>.
	 * 
	...
	/**
	 * Returns <SPAN CLASS="MATH"><I>x</I><SUB>b</SUB></SPAN> such that the
	 * probability density is 0 everywhere outside the interval <SPAN
	 * CLASS="MATH">[<I>x</I><SUB>a</SUB>, <I>x</I><SUB>b</SUB>]</SPAN>.
	 * 
	...
	/**
	 * Sets the value <SPAN CLASS="MATH"><I>x</I><SUB>a</SUB> =</SPAN>
	 * <TT>xa</TT>, such that the probability density is 0 everywhere outside
	 * the interval <SPAN CLASS="MATH">[<I>x</I><SUB>a</SUB>,
	 * <I>x</I><SUB>b</SUB>]</SPAN>.
	 * 
	 * @param xa
	...
	/**
	 * Sets the value <SPAN CLASS="MATH"><I>x</I><SUB>b</SUB> =</SPAN>
	 * <TT>xb</TT>, such that the probability density is 0 everywhere outside
	 * the interval <SPAN CLASS="MATH">[<I>x</I><SUB>a</SUB>,
	 * <I>x</I><SUB>b</SUB>]</SPAN>.
	 * 
	 * @param xb
