...
/**
 * Extends the class {@link ContinuousDistribution} for the <EM>beta</EM>
 * distribution with shape parameters
 * 
 * <SPAN CLASS="MATH"><I>&#945;</I> &gt; 0</SPAN> and <SPAN
 * CLASS="MATH"><I>&#946;</I> &gt; 0</SPAN>, over the interval <SPAN
 * CLASS="MATH">(<I>a</I>, <I>b</I>)</SPAN>, where <SPAN CLASS="MATH"><I>a</I>
 * &lt; <I>b</I></SPAN>. It has density
 * 
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>f</I> (<I>x</I>) = (<I>x</I> -
 * <I>a</I>)<SUP><I>&#945;</I>-1</SUP>(<I>b</I> -
 * <I>x</I>)<SUP><I>&#946;</I>-1</SUP>/[<I>B</I>(<I>&#945;</I>,
 * <I>&#946;</I>)(<I>b</I> - <I>a</I>)<SUP><I>&#945;</I>+<I>&#946;</I>-1</SUP>]
 * </DIV>
 * <P>
 * </P>
 * for <SPAN CLASS="MATH"><I>a</I> &lt; <I>x</I> &lt; <I>b</I></SPAN>, and 0
 * elsewhere. It has distribution function
 * 
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>F</I>(<I>x</I>) =
 * <I>I</I><SUB><I>&#945;</I>, <I>&#946;</I></SUB>(<I>x</I>) =
 * &int;<SUB>a</SUB><SUP>x</SUP>(<I>&#958;</I> -
 * <I>a</I>)<SUP><I>&#945;</I>-1</SUP>(<I>b</I> -
 * <I>&#958;</I>)<SUP><I>&#946;</I>-1</SUP>/[<I>B</I>(<I>&#945;</I>,
 * <I>&#946;</I>)(<I>b</I> -
 * <I>a</I>)<SUP><I>&#945;</I>+<I>&#946;</I>-1</SUP>]<I
 * >d&#958;</I>,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for <I>a</I>
 * &lt; <I>x</I> &lt; <I>b</I>, </DIV>
 * <P>
 * </P>
 * where <SPAN CLASS="MATH"><I>B</I>(<I>&#945;</I>, <I>&#946;</I>)</SPAN> is the
 * <EM>beta</EM> function defined by
 * 
 * <P>
 * </P>
 ...
 * <I>B</I>(<I>&#945;</I>, <I>&#946;</I>) =
 * <I>&#915;</I>(<I>&#945;</I>)<I>&#915;
 * </I>(<I>&#946;</I>)/<I>&#915;</I>(<I>&#945;</I> + <I>&#946;</I>), </DIV>
 * <P>
 * </P>
 * and <SPAN CLASS="MATH"><I>&#915;</I>(<I>x</I>)</SPAN> is the gamma function
 * defined in {@link GammaDist}.
 * 
 */
public class BetaDist extends ContinuousDistribution {
	...
	/**
	 * Constructs a <TT>BetaDist</TT> object with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I> =</SPAN> <TT>alpha</TT> and <SPAN
	 * CLASS="MATH"><I>&#946;</I> =</SPAN> <TT>beta</TT> and default domain
	 ...
	 * Constructs a <TT>BetaDist</TT> object with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I> =</SPAN> <TT>alpha</TT> and <SPAN
	 * CLASS="MATH"><I>&#946;</I> =</SPAN> <TT>beta</TT>, and domain <SPAN
	 * CLASS="MATH">(</SPAN><TT>a</TT><SPAN CLASS="MATH">,</SPAN>&nbsp;
	 * <TT>b</TT><SPAN CLASS="MATH">)</SPAN>.
	 * 
	 */
	 ...
	 * Constructs a <TT>BetaDist</TT> object with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I> =</SPAN> <TT>alpha</TT> and <SPAN
	 * CLASS="MATH"><I>&#946;</I> =</SPAN> <TT>beta</TT>, and approximations of
	 * roughly <TT>d</TT> decimal digits of precision when computing the
	 * distribution, complementary distribution, and inverse functions. The
	 * default domain <SPAN CLASS="MATH">(0, 1)</SPAN> is used.
	 * 
	 */
	 ...
	 * CLASS="MATH"><I>&#945;</I> =</SPAN> <TT>alpha</TT> and <SPAN
	 * CLASS="MATH"><I>&#946;</I> =</SPAN> <TT>beta</TT>, and approximations of
	 * roughly <TT>d</TT> decimal digits of precision when computing
	 * distribution, complementary distribution, and inverse functions. The
	 * domain <SPAN CLASS="MATH">(</SPAN><TT>a</TT><SPAN
	 * CLASS="MATH">,</SPAN>&nbsp;<TT>b</TT><SPAN CLASS="MATH">)</SPAN> is used.
	 * 
	 */
	...
	public double density(double x) {
		if (x <= a || x >= b)
			return 0;
		double temp = (alpha - 1) * Math.log(x - a) + (beta - 1)
				* Math.log(b - x);
	...
	/**
	 * Same as {@link #density(double,double,double,double,double) density}
	 * &nbsp;<TT>(alpha, beta, 0, 1, x)</TT>.
	 * 
	 */
	...
	public static double density(double alpha, double beta, double a, double b,
		...
		double z = -Num.lnBeta(alpha, beta) - (alpha + beta - 1)
				* Math.log(b - a) + (alpha - 1) * Math.log(x - a) + (beta - 1)
				* Math.log(b - x);
		return Math.exp(z);
	}
	 ...
	 * that copying is by permission of the Association for Computing Machinery.
	 * To copy otherwise, or to republish, requires a fee and/or specific
	 * permission.
	 */

	/*
	 * Part of the algorithm for the cdf below is taken from W. Gautschi,
	 * Algorithm 222: Incomplete Beta Function Ratios, Communications of the
	 * ACM, Vol. 7, 3, pp 143-144, 1964.
	 */
	private static double isubx_alphabeta_small(double alpha, double beta,
			double x, int d)
	/*
	 * Evaluates beta (alpha, beta, d, x) when 0 < alpha <= 1 and 0 < beta <= 2
	 * to a precision of d = -log10 (2 epsilon) decimal digits. Uses a series
	 ...
	 */
	{
		...
		if (nmax > 0)
			I[1] = I1;
		for (n = 1; n < nmax; n++)
			I[n + 1] = (1 + (n - 1 + alpha + beta) * (1. - x) / (n + beta))
					* I[n] - (n - 1 + alpha + beta) * (1. - x) * I[n - 1]
					/ (n + beta);
	}
	...
	/*
	 * Given I0 = beta (alpha, beta, x), generates beta (alpha + n, beta, x) for
	 * n = 0, 1, 2,..., nmax to d significant digits, using a variant of J.C.P.
	 * Miller's backward recurrence algorithm. Stores the result in I. Reference
	 * ???
	 */
	{
		int n, nu, m, ntab;
	...
	/*
	 * Used in the normal approximation of beta. This is the function (1.0 - x*x
	 * + 2.0*x*log (x))/((1.0 - x)*(1.0 - x)).
	 */
	{
		double epsilon;
	...
	/**
	 * Same as {@link #cdf(double,double,double,double,int,double) cdf}&nbsp;
	 * <TT>(alpha, beta, 0, 1, d, x)</TT>.
	 * 
	 */
	public static double cdf(double alpha, double beta, int d, double x) {
		/*
		 * The exact section of beta below is very slow for large parameters. It
		 * is an old algorithm of Gautschi (1964). There is an algorithm for
		 * beta that is recent and is supposed to be very fast. ACM Trans. Math.
		 * Soft. 18, pp 360, (1992). (R. Simard.)
		 */

		/*
		 * I[j] will contain either the values of cdf (alpha0 + j, beta, d, x),
		 * where 0 < alpha0 <= 1, for j = 0, 1, 2, ..., n, with alpha = alpha0 +
		 * n; or the values of cdf (alpha, beta0 + j, d, x), where 0 < beta0 <=
		 * 1, for j = 0, 1, 2, ..., n, with beta = beta0 + n.
		 */
		...
		if (Math.max(alpha, beta) <= ALPHABETAMAX) {
			if (alpha < beta) {
				...
				u = I[n];
				/*
				 * There may be numerical errors far in the tails giving very
		...
		if ((alpha > ALPHABETAMAX && beta < ALPHABETALIM)
			...
			if (!flag)
				...
				temp = (1.0 - x) / (1.0 + x);
			yd = 2.0 * u * temp;
			gam = (Math.exp(beta * Math.log(yd) - yd - Num.lnGamma(beta)) * (2.0
					* yd * yd - (beta - 1.0) * yd - (beta * beta - 1.0)))
					/ (24.0 * u * u);
			if (flag) {
		...
		h1 = alpha + beta - 1.0;
		y = 1.0 - x;
		h3 = Math.sqrt((1.0 + y * beta_g((alpha - 0.5) / (h1 * x), d) + x
				* beta_g((beta - 0.5) / (h1 * y), d))
				/ ((h1 + 1.0 / 6.0) * x * y))
	...
	/**
	 * Same as {@link #barF(double,double,double,double,int,double) barF}&nbsp;
	 * <TT>(alpha, beta, 0, 1, d, x)</TT>.
	 * 
	 */
	...
	/**
	 * Same as {@link #inverseF(double,double,double,double,int,double)
	 * inverseF}&nbsp;<TT>(alpha, beta, 0, 1, d, u)</TT>.
	 * 
	 */
	public static double inverseF(double alpha, double beta, int d, double u) {
		...
		/*
		 * Code taken from Cephes Math Library Release 2.8: June, 2000 Copyright
		 * 1984, 1996, 2000 by Stephen L. Moshier
		 */
		...
		mainloop: while (true) {
			...
			if (newt) {
				...
				for (i = 0; i < 8; i++) {
					...
					z = (p - 1.0) * Math.log(x) + (q - 1.0) * Math.log1p(-x)
							+ lgm;
					if (z < MINLOG)
						break mainloop;
					if (z > MAXLOG)
	 ...
	 * implemented in the <A NAME="tex2html1"
	 * HREF="http://www.moshier.net/">Cephes math library</A>. The method
	 * performs interval halving or Newton iterations to compute the inverse.
	 * The precision depends on the accuracy of the {@link #cdf cdf} method. The
	 * argument <TT>d</TT> gives a good idea of the precision attained.
	 * 
	 */
	...
	/**
	 * Estimates the parameters <SPAN CLASS="MATH">(<I>&#945;</I>,
	 * <I>&#946;</I>)</SPAN> of the beta distribution over the interval <SPAN
	 * CLASS="MATH">[0, 1]</SPAN> using the maximum likelihood method, from the
	 * <SPAN CLASS="MATH"><I>n</I></SPAN> observations <SPAN
	 * CLASS="MATH"><I>x</I>[<I>i</I>]</SPAN>, <SPAN CLASS="MATH"><I>i</I> = 0,
	 * 1,&#8230;, <I>n</I> - 1</SPAN>. The estimates are returned in a
	 * two-element array, in regular order: [<SPAN
	 * CLASS="MATH"><I>&#945;</I></SPAN>, <SPAN
	 * CLASS="MATH"><I>&#946;</I></SPAN>].
	 * 
	 * @param x
	 ...
	 * 
	 * @return returns the parameters [ <SPAN CLASS="MATH">hat(&alpha;)</SPAN>,
	...
	public static double[] getMLE(double[] x, int n) {
		...
		Minpack_f77.lmder1_f77(system, 2, 2, param, fvec, fjac, 1e-5, info,
				ipvt);
	...
	/**
	 * Creates a new instance of a beta distribution with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#946;</I></SPAN> over the interval <SPAN
	 * CLASS="MATH">[0, 1]</SPAN> estimated using the maximum likelihood method
	 * based on the <SPAN CLASS="MATH"><I>n</I></SPAN> observations <SPAN
	 * CLASS="MATH"><I>x</I>[<I>i</I>]</SPAN>, <SPAN CLASS="MATH"><I>i</I> = 0,
	 * 1,&#8230;, <I>n</I> - 1</SPAN>.
	 * 
	 * @param x
	 ...
	 * <I>&#945;</I>/(<I>&#945;</I> + <I>&#946;</I>)</SPAN> of the beta
	 * distribution with parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and
	 * <SPAN CLASS="MATH"><I>&#946;</I></SPAN>, over the interval <SPAN
	 * CLASS="MATH">[0, 1]</SPAN>.
	 * 
	 ...
	 * 
	 * <SPAN CLASS="MATH"><I>E</I>[<I>X</I>] = (<I>b&#945;</I> +
	 * <I>a&#946;</I>)/(<I>&#945;</I> + <I>&#946;</I>)</SPAN> of the beta
	 * distribution with parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and
	 * <SPAN CLASS="MATH"><I>&#946;</I></SPAN> over the interval <SPAN
	 * CLASS="MATH">[<I>a</I>, <I>b</I>]</SPAN>.
	 * 
	 * @return the mean of the Beta distribution
	 * 
	 */
	 ...
	 * 
	 * <SPAN CLASS="MATH">Var[<I>X</I>] = <IMG ALIGN="MIDDLE" BORDER="0"
	 * SRC="BetaDistimg1.png" ALT="$ {\frac{{\alpha\beta}}{{(\alpha + \beta)^2
	 * (\alpha + \beta + 1)}}}$"></SPAN> of the beta distribution with
	 * parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#946;</I></SPAN>, over the interval <SPAN
	 * CLASS="MATH">[0, 1]</SPAN>.
	 * 
	 * @return the variance of the beta distribution
	 * 
	 *         <SPAN CLASS="MATH">Var[<I>X</I>] =
	 *         <I>&#945;&#946;</I>/[(<I>&#945;</I> +
	 *         <I>&#946;</I>)<SUP>2</SUP>(<I>&#945;</I> + <I>&#946;</I> +
	 *         1)]</SPAN>.
	 * 
	 */
	 ...
	 * 
	 * <SPAN CLASS="MATH">Var[<I>X</I>] = <IMG ALIGN="MIDDLE" BORDER="0"
	 * SRC="BetaDistimg2.png" ALT="$ {\frac{{\alpha\beta(b-a)^2}}{{(\alpha +
	 * \beta)^2 (\alpha + \beta + 1)}}}$"></SPAN> of the beta distribution with
	 * parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#946;</I></SPAN>, over the interval <SPAN
	 * CLASS="MATH">[<I>a</I>, <I>b</I>]</SPAN>.
	 * 
	...
	/**
	 * Computes the standard deviation of the beta distribution with parameters
	 * <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#946;</I></SPAN>, over the interval <SPAN
	 * CLASS="MATH">[0, 1]</SPAN>.
	 * 
	...
	/**
	 * Returns the parameter <SPAN CLASS="MATH"><I>&#945;</I></SPAN> of this
	 * object.
	 * 
	 */
	...
	/**
	 * Returns the parameter <SPAN CLASS="MATH"><I>&#946;</I></SPAN> of this
	 * object.
	 * 
	 */
	...
	/**
	 * Return a table containing parameters of the current distribution. This
	 * table is put in regular order: [<SPAN CLASS="MATH"><I>&#945;</I></SPAN>,
	 * <SPAN CLASS="MATH"><I>&#946;</I></SPAN>].
	 * 
	 * 
	 */
	...
	public String toString() {
		return getClass().getSimpleName() + " : alpha = " + alpha + ", beta = "
				+ beta;
	}
