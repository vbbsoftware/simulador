...
/**
 * Extends the class {@link ContinuousDistribution} for the <EM>gamma</EM>
 * distribution with shape parameter <SPAN CLASS="MATH"><I>&#945;</I> &gt;
 * 0</SPAN> and scale parameter
 * 
 * <SPAN CLASS="MATH"><I>&#955;</I> &gt; 0</SPAN>. The density is
 * 
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>f</I> (<I>x</I>) =
 * <I>&#955;</I><SUP
 * ><I>&#945;</I></SUP><I>x</I><SUP><I>&#945;</I>-1</SUP><I>e</I
 * ><SUP>-<I>&#955;<
 * /I>x</SUP>/<I>&#915;</I>(<I>&#945;</I>),&nbsp;&nbsp;&nbsp;&nbsp
 * ;&nbsp;&nbsp;&nbsp;&nbsp;for <I>x</I> &gt; 0, </DIV>
 * <P>
 * </P>
 * where <SPAN CLASS="MATH"><I>&#915;</I></SPAN> is the gamma function, defined
 * by
 * 
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>&#915;</I>(<I>&#945;</I>) =
 * &int;<
 * SUB>0</SUB><SUP>&#8734;</SUP><I>x</I><SUP><I>&#945;</I>-1</SUP><I>e</I><
 * SUP>-x</SUP><I>dx</I>. </DIV>
 * <P>
 * </P>
 * In particular, <SPAN CLASS="MATH"><I>&#915;</I>(<I>n</I>) = (<I>n</I> -
 * 1)!</SPAN> when <SPAN CLASS="MATH"><I>n</I></SPAN> is a positive integer.
 * 
 */
public class GammaDist extends ContinuousDistribution {
	...
	/**
	 * Constructs a <TT>GammaDist</TT> object with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I></SPAN> = <TT>alpha</TT> and <SPAN
	 * CLASS="MATH"><I>&#955;</I> = 1</SPAN>.
	 * 
	 */
	 ...
	 * Constructs a <TT>GammaDist</TT> object with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I></SPAN> = <TT>alpha</TT> and <SPAN
	 * CLASS="MATH"><I>&#955;</I></SPAN> = <TT>lambda</TT>.
	 * 
	 */
	 ...
	 * Constructs a <TT>GammaDist</TT> object with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I></SPAN> = <TT>alpha</TT> and <SPAN
	 * CLASS="MATH"><I>&#955;</I></SPAN> = <TT>lambda</TT>, and approximations
	 * of roughly <TT>d</TT> decimal digits of precision when computing
	 * functions.
	 * 
	 */
	...
	public static double density(double alpha, double lambda, double x) {
		...
		if (x <= 0)
			return 0.0;
		double z = alpha * Math.log(lambda * x) - lambda * x
				- Num.lnGamma(alpha);
		if (z > -XBIGM)
			return Math.exp(z) / x;
		else
	 ...
	 * parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> = <TT>alpha</TT> and
	 * <SPAN CLASS="MATH"><I>&#955;</I></SPAN> = <TT>lambda</TT>. The function
	 * tries to return <SPAN CLASS="MATH"><I>d</I></SPAN> decimals digits of
	 * precision. For <SPAN CLASS="MATH"><I>&#945;</I></SPAN> not too large
	 * (e.g., <SPAN CLASS="MATH"><I>&#945;</I>&nbsp;&lt;=&nbsp;1000</SPAN>),
	 * <SPAN CLASS="MATH"><I>d</I></SPAN> gives a good idea of the precision
	 * attained.
	 * 
	 */
	...
	/**
	 * Same as {@link #barF(double,double,int,double) barF}&nbsp;
	 * <TT>(alpha, 1.0, d, x)</TT>.
	 * 
	 */
	...
	/**
	 * Same as {@link #inverseF(double,double,int,double) inverseF}&nbsp;
	 * <TT>(alpha, 1, d, u)</TT>.
	 * 
	 */
	 ...
	 * <I>&#955;</I>)</SPAN> of the gamma distribution using the maximum
	...
	/**
	 * Creates a new instance of a gamma distribution with parameters <SPAN
	 * CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#955;</I></SPAN> estimated using the maximum likelihood
	 ...
	 * <I>&#945;</I>/<I>&#955;</I></SPAN> of the gamma distribution with
	 * parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#955;</I></SPAN>.
	 * 
	 * @return the mean of the gamma distribution <SPAN
	 *         CLASS="MATH"><I>E</I>[<I>X</I>] =
	 *         <I>&#945;</I>/<I>&#955;</I></SPAN>
	 * 
	 */
	 ...
	 * <I>&#945;</I>/<I>&#955;</I><SUP>2</SUP></SPAN> of the gamma distribution
	 * with parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#955;</I></SPAN>.
	 * 
	 * @return the variance of the gamma distribution <SPAN
	 *         CLASS="MATH">Var[<I>X</I>] =
	 *         <I>&#945;</I>/<I>&#955;</I><SUP>2</SUP></SPAN>
	 * 
	 */
	...
	/**
	 * Computes and returns the standard deviation of the gamma distribution
	 * with parameters <SPAN CLASS="MATH"><I>&#945;</I></SPAN> and <SPAN
	 * CLASS="MATH"><I>&#955;</I></SPAN>.
	 * 
	...
	/**
	 * Return the parameter <SPAN CLASS="MATH"><I>&#945;</I></SPAN> for this
	 * object.
	 * 
	 */
	...
	/**
	 * Return the parameter <SPAN CLASS="MATH"><I>&#955;</I></SPAN> for this
	 * object.
	 * 
	 */
