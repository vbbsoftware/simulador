...
/**
 * Extends the class {@link ContinuousDistribution} for the <EM>exponential</EM>
 * distribution with mean <SPAN CLASS="MATH">1/<I>&#955;</I></SPAN> where <SPAN
 * CLASS="MATH"><I>&#955;</I> &gt; 0</SPAN>. Its density is
 * 
 * <P>
 * </P>
 ...
 * <P>
 * </P>
 * <DIV ALIGN="CENTER" CLASS="mathdisplay"> <I>F</I>(<I>x</I>) = 1 -
 * <I>e</I><SUP
 * >-<I>&#955;</I>x</SUP>,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for
 * <I>x</I>&nbsp;&gt;=&nbsp;0, </DIV>
 * <P>
...
public class ExponentialDist extends ContinuousDistribution {
	...
	/**
	 * Constructs an <TT>ExponentialDist</TT> object with parameter <SPAN
	 * CLASS="MATH"><I>&#955;</I></SPAN> = 1.
	 * 
	 */
	...
	/**
	 * Estimates the parameter <SPAN CLASS="MATH"><I>&#955;</I></SPAN> of the
	 * exponential distribution using the maximum likelihood method, from the
	 * <SPAN CLASS="MATH"><I>n</I></SPAN> observations <SPAN
	 * CLASS="MATH"><I>x</I>[<I>i</I>]</SPAN>, <SPAN CLASS="MATH"><I>i</I> = 0,
	 * 1,&#8230;, <I>n</I> - 1</SPAN>. The estimate is returned in a one-element
	 * array, as element 0.
	 * 
	 * @param x
	 ...
	 * 
	 * @return returns the parameter [ <SPAN CLASS="MATH">hat(&lambda;)</SPAN>]
	 * 
	 */
	 ...
	 * <SPAN CLASS="MATH"><I>&#955;</I></SPAN> estimated using the maximum
	 ...
	 * 1/<I>&#955;</I></SPAN>, of the exponential distribution with parameter
	 * <SPAN CLASS="MATH"><I>&#955;</I></SPAN>.
	 * 
	 * @return the mean of the exponential distribution <SPAN
	 *         CLASS="MATH"><I>E</I>[<I>X</I>] = 1/<I>&#955;</I></SPAN>
	 * 
	 */
	 ...
	 * 1/<I>&#955;</I><SUP>2</SUP></SPAN>, of the exponential distribution with
	 * parameter <SPAN CLASS="MATH"><I>&#955;</I></SPAN>.
	 * 
	 * @return the variance of the Exponential distribution <SPAN
	 *         CLASS="MATH">Var[<I>X</I>] = 1/<I>&#955;</I><SUP>2</SUP></SPAN>
	 * 
	 */
	 ...
	 * distribution with parameter <SPAN CLASS="MATH"><I>&#955;</I></SPAN>.
	 * 
	...
	/**
	 * Returns the value of <SPAN CLASS="MATH"><I>&#955;</I></SPAN> for this
	 * object.
	 * 
	 */
	...
	/**
	 * Sets the value of <SPAN CLASS="MATH"><I>&#955;</I></SPAN> for this
	 * object.
	 * 
	 */
